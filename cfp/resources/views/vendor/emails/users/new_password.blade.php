    ...
    <tr>
        <td style="{{ $style['email-wrapper'] }}" align="center">
            <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{ $style['paragraph'] }}">
                                        Sua nova senha gerada para seu acesso.<br />
                                        Link e seus dados de acesso seguem abaixo.
                                    </p>
                                    <p style="{{ $style['paragraph'] }}">
                                        <strong>Usuário:</strong> {{ $data->email }}<br />
                                        <strong>Senha:</strong> {{ $password }}<br />
                                        <strong>Link de acesso:</strong> <a href="{{ route('login') }}">{{ route('login') }}</a>
                                    </p>
                                ...
                                <!-- Action Button -->
                                    ...
                                    <!-- Sub Copy -->
                                    @include('vendor.emails.inc.sub_copy')
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <!-- Footer -->
                @include('vendor.emails.inc.footer')
            </table>
        </td>
    </tr>
</table>
