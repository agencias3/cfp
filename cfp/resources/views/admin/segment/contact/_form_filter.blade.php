{!! Form::open(['route' => ['admin.segment.contact.index', $id], 'method' => 'get']) !!}
<div class="row">
    <div class="col-md-12">
        <div class="col-md-6">
    ...
    <div class="col-md-12 text-right">
        <a href="{{ route('admin.segment.contact.index', $id) }}" title="Limpar" class="btn btn-danger mb-md"><i class="fa fa-trash"></i> Limpar</a>
