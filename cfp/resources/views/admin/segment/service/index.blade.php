...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::open(['route'=>'admin.segment.service.store', 'files'=> true]) !!}
                <div class="panel-body">
                    ...
                    @include('admin.segment.service._form')
                </div>
        ...
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title">Serviços</h2>
            </header>
            <div class="panel-body">
                <table class="table table-no-more table-bordered table-striped mb-0">
                    ...
                    @foreach($dados as $row)
                        <tr>
                            <td data-title="Serviço">{{ $row->service->name }}</td>
                            <td data-title="Ação" class="actions text-center">
                                <a href="#modalDestroy" data-route="{{ route('admin.segment.service.destroy', ['id' => $row->id]) }}" class="excluir remove-row btn btn-danger white" title="Excluir">
