...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::model($dados, ['route'=>['admin.team.update', $dados->id], 'files' => true]) !!}
                <div class="panel-body">
                    @include('admin.layouts._msg')

                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <a href="{{ route('admin.team.index') }}" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-undo"></i> Voltar</a>
                        </div>
                    </div>
