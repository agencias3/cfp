<div class="row">
    <div class="col-sm-12 text-right">
        <a href="{{ route('admin.blog.post.segment.index', ['id' => $idRoute]) }}" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-tags"></i> Segmentos</a>
        <a href="{{ route('admin.blog.post.services.index', ['id' => $idRoute]) }}" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-tags"></i> Serviços</a>
