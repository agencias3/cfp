...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::open(['route'=>'admin.blog.post.segment.store', 'files'=> true]) !!}
                <div class="panel-body">
                    ...
                    @include('admin.blog.post.segment._form')
                    ...
                    @foreach($dados as $row)
                        <tr>
                            ...
                            <td data-title="Ação" class="actions text-center">
                                <a href="#modalDestroy" data-route="{{ route('admin.blog.post.segment.destroy', ['id' => $row->id]) }}" class="excluir remove-row btn btn-danger white" title="Excluir">
