            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                        <a href="{{ route('admin.service.contact.index', $dados->service_id) }}" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-undo"></i> Voltar</a>
                    </div>
                </div>

                <h3>{{ $dados->service->name }}</h3>
